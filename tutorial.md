...
- _Multiplication_ refers to the practice of multiplying code files to keep track of their versions, inserting information about the version in the filename. For example, the first version of a TMS-EEG preprocessing pipeline can reside in a file named `pipeline_v1.py`, the second version in a file named `pipeline_v2.py`, the third version in a file named `pipeline_v3.py`, etc. 
...
![git-init](https://drive.google.com/file/d/1uHygH-k0oi05tm-M78lJcXcL08AigizB/view?usp=drive_link)
