...
To follow along the tutorial and start doing version control, users will need a Git installation and GitHub account. 

The instructions to install Git are available on the official website at [this](https://git-scm.com/) link. A GitHub account can be created from the [GitHub homepage](https://github.com/).

## Contacts

For questions or improvement suggestions, you can contact Matteo De Matola ([UniTN](https://webapps.unitn.it/du/en/Persona/PER0247884/Curriculum) | [GitHub](https://github.com/matteo-d-m)).
